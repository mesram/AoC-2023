...
print("Day 1.1: \(Day1.part1)")
print("Day 1.2: \(Day1.part2)")
...
struct Day1 {
    static var part1: Int { get {
        ...
        return getMatch(Self.input, forward: regex, backward: regex)
    }}

    static var part2: Int { get {
        let forward = Regex {
            Capture {
                ChoiceOf {
                    CharacterClass.digit
        ...
        return getMatch(Self.input, forward: forward, backward: backward)
    }}
