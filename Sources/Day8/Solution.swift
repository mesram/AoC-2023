...
//print("Day 8.1: \(Day8.part1)")
print("Day 8.2: \(Day8.part2)")
...
struct Path {
    ...
    func addingPrevious(node: String, instruction: String) -> Self {
        .init(
            start: node,
            finish: self.finish,
...
struct Day8 {
    ...
    static var part2: Int {
        ...
        let instructions = lines[0].split(separator: "").map(String.init)
